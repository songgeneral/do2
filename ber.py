...
#df = pd.read_excel("kbars_元大_1100701_1100708_2.xlsx")
#df = pd.read_excel("kbars_0050_2022-01-01-2022-11-30.xlsx")
df_original = pd.read_excel("kbars_0050_2022-01-01-2022-11-30.xlsx")
# ## 讀取 excel 檔
# df_original = pd.read_excel("kbars_0050_2022-01-01-2022-11-30.xlsx")

# ## 保存为Pickle文件:
# df_original.to_pickle('kbars_0050_2022-01-01-2022-11-30.pkl')

## 读取Pickle文件
# df_original = pd.read_pickle('kbars_0050_2022-01-01-2022-11-30.pkl')
...
##### 選擇資料區間
st.subheader("選擇開始與結束的日期, 區間:2022-01-01 至 2022-11-30")
start_date = st.text_input('選擇開始日期 (日期格式: 2022-01-01)', '2022-01-01')
end_date = st.text_input('選擇結束日期 (日期格式: 2022-11-30)', '2022-11-30')
